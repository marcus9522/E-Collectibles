...
<label for="data">DATA DI NASCITA:</label><br> 
		<input name="data_nascita" type="date" required value="<%=utente.getData_nascita() %>" ><br>
...
window.location.href= 'http://localhost:8080/e-collectibles/utente2?azione=logout';
</script><%} } %>
</section>
